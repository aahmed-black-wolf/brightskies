...
import { isValidConnection, getExecutionOrder, simulateNodeExecution } from './pipeline';
...
describe('pipeline utilities', () => {
  ...
  describe('getExecutionOrder', () => {
    it('should return nodes in topological order', () => {
      const nodes: PipelineNode[] = [
        { id: 'node1', type: 'Data Source', name: 'Source', position: { x: 0, y: 0 } },
        { id: 'node2', type: 'Transformer', name: 'Transform', position: { x: 0, y: 0 } },
    ...
    it('should handle multiple sources', () => {
      const nodes: PipelineNode[] = [
        { id: 'node1', type: 'Data Source', name: 'Source1', position: { x: 0, y: 0 } },
        { id: 'node2', type: 'Data Source', name: 'Source2', position: { x: 0, y: 0 } },
        { id: 'node3', type: 'Sink', name: 'Sink', position: { x: 0, y: 0 } },
      ];
      const edges: PipelineEdge[] = [
  ...
  describe('simulateNodeExecution', () => {
    ...
    it('should generate correct log for Transformer', () => {
      const log = simulateNodeExecution('node2', 'Feature Scaling', 'Transformer');
